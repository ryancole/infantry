...
- Netcode, the rest of it: delta-compressed snapshots, predicted muzzle effects so your own shot sounds on the press, a connect-to-IP box in the menu, server discovery
